...
class uploadFile{
	...
	public function setUnique(){
		...
		$this->upload_Filename = $uniqueId."_".$this->upload_Filename;
	}
	...
	/*
	* Methode: change les droits (mode) pour la creation des dossiers
	*
	*	@param numeric $chmod: mode du fichier (nombre en notation octale)
	*
	*	@return nouvelle valeur du mode
	*/
